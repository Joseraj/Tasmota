...
// -- Location ------------------------------------
#define LATITUDE               45.5943           // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              11.5811           // [Longitude] Your location to be used with sunrise and sunset
